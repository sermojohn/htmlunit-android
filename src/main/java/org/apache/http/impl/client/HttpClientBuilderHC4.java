 ...
 */
@NotThreadSafe
public class HttpClientBuilderHC4 {
    ...
    static {
        final VersionInfo vi = VersionInfo.loadVersionInfo
            ("org.apache.http.client", HttpClientBuilderHC4.class.getClassLoader());
        final String release = (vi != null) ?
            vi.getRelease(): VersionInfo.UNAVAILABLE;
        DEFAULT_USER_AGENT = "Apache-HttpClient/" + release + " (java 1.5)";
    }

    public static HttpClientBuilderHC4 create() {
        return new HttpClientBuilderHC4();
    }

    protected HttpClientBuilderHC4() {
        super();
    }
     ...
     */
    public final HttpClientBuilderHC4 setRequestExecutor(final HttpRequestExecutor requestExec) {
     ...
     */
    public final HttpClientBuilderHC4 setHostnameVerifier(final X509HostnameVerifier hostnameVerifier) {
     ...
     *org.apache.http.conn.socket.LayeredConnectionSocketFactory)} methods.
     */
    public final HttpClientBuilderHC4 setSslcontext(final SSLContext sslcontext) {
     ...
     */
    public final HttpClientBuilderHC4 setSSLSocketFactory(
     ...
     *org.apache.http.conn.HttpClientConnectionManager)} method.
     */
    public final HttpClientBuilderHC4 setMaxConnTotal(final int maxConnTotal) {
     ...
     *org.apache.http.conn.HttpClientConnectionManager)} method.
     */
    public final HttpClientBuilderHC4 setMaxConnPerRoute(final int maxConnPerRoute) {
     ...
     *org.apache.http.conn.HttpClientConnectionManager)} method.
     */
    public final HttpClientBuilderHC4 setDefaultSocketConfig(final SocketConfig config) {
     ...
     *org.apache.http.conn.HttpClientConnectionManager)} method.
     */
    public final HttpClientBuilderHC4 setDefaultConnectionConfig(final ConnectionConfig config) {
     ...
     */
    public final HttpClientBuilderHC4 setConnectionManager(
     ...
     */
    public final HttpClientBuilderHC4 setConnectionReuseStrategy(
     ...
     */
    public final HttpClientBuilderHC4 setKeepAliveStrategy(
     ...
     * authentication.
     */
    public final HttpClientBuilderHC4 setTargetAuthenticationStrategy(
     ...
     * host authentication.
     */
    public final HttpClientBuilderHC4 setProxyAuthenticationStrategy(
     ...
     * method.
     */
    public final HttpClientBuilderHC4 setUserTokenHandler(final UserTokenHandler userTokenHandler) {
     ...
     */
    public final HttpClientBuilderHC4 disableConnectionState() {
     ...
     */
    public final HttpClientBuilderHC4 setSchemePortResolver(
     ...
     */
    public final HttpClientBuilderHC4 setUserAgent(final String userAgent) {
     ...
     *org.apache.http.protocol.HttpProcessor)} method.
     */
    public final HttpClientBuilderHC4 setDefaultHeaders(final Collection<? extends Header> defaultHeaders) {
     ...
     *org.apache.http.protocol.HttpProcessor)} method.
     */
    public final HttpClientBuilderHC4 addInterceptorFirst(final HttpResponseInterceptor itcp) {
        if (itcp == null) {
            return this;
        }
     ...
     *org.apache.http.protocol.HttpProcessor)} method.
     */
    public final HttpClientBuilderHC4 addInterceptorLast(final HttpResponseInterceptor itcp) {
        if (itcp == null) {
            return this;
        }
     ...
     *org.apache.http.protocol.HttpProcessor)} method.
     */
    public final HttpClientBuilderHC4 addInterceptorFirst(final HttpRequestInterceptor itcp) {
        if (itcp == null) {
            return this;
        }
     ...
     *org.apache.http.protocol.HttpProcessor)} method.
     */
    public final HttpClientBuilderHC4 addInterceptorLast(final HttpRequestInterceptor itcp) {
        if (itcp == null) {
            return this;
        }
        if (requestLast == null) {
     ...
     *org.apache.http.protocol.HttpProcessor)} method.
     */
    public final HttpClientBuilderHC4 disableCookieManagement() {
     ...
     *org.apache.http.protocol.HttpProcessor)} method.
     */
    public final HttpClientBuilderHC4 disableContentCompression() {
     ...
     *org.apache.http.protocol.HttpProcessor)} method.
     */
    public final HttpClientBuilderHC4 disableAuthCaching() {
     ...
     */
    public final HttpClientBuilderHC4 setHttpProcessor(final HttpProcessor httpprocessor) {
     ...
     * method.
     */
    public final HttpClientBuilderHC4 setRetryHandler(final HttpRequestRetryHandler retryHandler) {
     ...
     */
    public final HttpClientBuilderHC4 disableAutomaticRetries() {
     ...
     */
    public final HttpClientBuilderHC4 setProxy(final HttpHost proxy) {
        this.proxy = proxy;
        return this;
    }
     ...
     */
    public final HttpClientBuilderHC4 setRoutePlanner(final HttpRoutePlanner routePlanner) {
     ...
     * `
     */
    public final HttpClientBuilderHC4 setRedirectStrategy(final RedirectStrategy redirectStrategy) {
     ...
     */
    public final HttpClientBuilderHC4 disableRedirectHandling() {
     ...
     */
    public final HttpClientBuilderHC4 setConnectionBackoffStrategy(
     ...
     */
    public final HttpClientBuilderHC4 setBackoffManager(final BackoffManager backoffManager) {
     ...
     */
    public final HttpClientBuilderHC4 setServiceUnavailableRetryStrategy(
     ...
     */
    public final HttpClientBuilderHC4 setDefaultCookieStore(final CookieStore cookieStore) {
     ...
     * context.
     */
    public final HttpClientBuilderHC4 setDefaultCredentialsProvider(
     ...
     * context.
     */
    public final HttpClientBuilderHC4 setDefaultAuthSchemeRegistry(
     ...
     * context.
     */
    public final HttpClientBuilderHC4 setDefaultCookieSpecRegistry(
     ...
     * context.
     */
    public final HttpClientBuilderHC4 setDefaultRequestConfig(final RequestConfig config) {
     ...
     * implementations.
     */
    public final HttpClientBuilderHC4 useSystemProperties() {
