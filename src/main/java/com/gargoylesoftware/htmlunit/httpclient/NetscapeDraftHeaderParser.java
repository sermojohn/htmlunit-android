...
import org.apache.http.conn.ssl.TokenParserHC4;
...
public class NetscapeDraftHeaderParser {
    ...
    private static final BitSet TOKEN_DELIMS = TokenParserHC4.INIT_BITSET('=', PARAM_DELIMITER);
    private static final BitSet VALUE_DELIMS = TokenParserHC4.INIT_BITSET(PARAM_DELIMITER);

    private final TokenParserHC4 tokenParser;

    public NetscapeDraftHeaderParser() {
        super();
        this.tokenParser = TokenParserHC4.INSTANCE;
    }
